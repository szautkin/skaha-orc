  ...
  cavern: [
    ...
    },
    {
      ...
      fields: [
        ...
        {
          name: 'fsGroup',
          label: 'FS Group (securityContext)',
          type: 'number',
          path: 'deployment.cavern.securityContext.fsGroup',
        },
      ],
    },
    {
  ...
  'storage-ui': [
    ...
    },
    {
      ...
      fields: [
        ...
        {
          name: 'cavernResourceID',
          label: 'Cavern Resource ID',
          type: 'text',
          path: 'deployment.storageUI.backend.services.cavern.resourceID',
          placeholder: 'ivo://cadc.nrc.ca/cavern',
        },
        {
          name: 'cavernNodeURIPrefix',
          label: 'Cavern Node URI Prefix',
          type: 'text',
          path: 'deployment.storageUI.backend.services.cavern.nodeURIPrefix',
          placeholder: 'vos://cadc.nrc.ca~cavern',
        },
        {
          name: 'cavernUserHomeDir',
          label: 'Cavern User Home Dir',
          type: 'text',
          path: 'deployment.storageUI.backend.services.cavern.userHomeDir',
          placeholder: '/home',
        },
      ],
    },
